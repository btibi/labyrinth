...
//		
//		String subPath1 = path(labyrinth3, start3, pills.get(0));
//		String subPath2 = path(labyrinth3, pills.get(0), pills.get(1));
//		String subPath3 = path(labyrinth3, pills.get(1), exit3);
//
//		String path3 = subPath1 + "," + s(subPath2) + "," + s(subPath3);
//		String[] split = path3.split(",");
//		LOG.info("Utvonal {} lepest tartalmaz. Lepesek: {}", split.length, path3);
	...
	private static String s(String subPath2) {
		List<String> l = Lists.newArrayList(subPath2.split(","));
		l.remove(0);
		subPath2 = Joiner.on(",").join(l);
		return subPath2;
	}
